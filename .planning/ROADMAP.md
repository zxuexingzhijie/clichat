...
**Plans**: 10 plans
Plans:
- [ ] 23-01-PLAN.md — Pack manifest contract and namespace utilities
- [ ] 23-02-PLAN.md — Pure loader, dependency ordering, and strict additive merge
- [ ] 23-03-PLAN.md — Deep validator for schema, dependency, namespace, and reference checks
- [ ] 23-04-PLAN.md — Classic Fantasy pack manifests and core codex restructure
- [ ] 23-05-PLAN.md — Classic Fantasy actor/story/relationship codex restructure and self-validation
- [ ] 23-06-PLAN.md — Authoring CLI init/validate/diff tooling
- [ ] 23-07-PLAN.md — Cached WorldState and pack-aware path helpers
- [ ] 23-08-PLAN.md — Pre-React cached boot and App WorldState integration
- [ ] 23-09-PLAN.md — Namespaced save migration and serializer updates
- [ ] 23-10-PLAN.md — Runtime lookup, package metadata, and final integration gates
